...
hevc_d3d12va AVOptions:
  ...
  -rc_mode           <int>        E..V....... Set rate control mode (from 0 to 4) (default auto)
     ...
     QVBR            4            E..V....... Quality-defined variable-bitrate
...
MPEG-2 video AVOptions:
  -cc_format         <int>        .D.V....... extract a specific Closed Captions format (from 0 to 4) (default auto)
     auto            0            .D.V....... pick first seen CC substream
     a53             1            .D.V....... pick A/53 Part 4 CC substream
     scte20          2            .D.V....... pick SCTE-20 CC substream
     dvd             3            .D.V....... pick DVD CC substream
     dish            4            .D.V....... pick Dish Network CC substream
...
Closed Captions Decoder AVOptions:
...
AVFormatContext AVOptions:
  ...
  -duration_probesize <int64>      .D......... Maximum number of bytes to probe the durations of the streams in estimate_timings_from_pts (from 0 to I64_MAX) (default 0)
...
http AVOptions:
  ...
  -user_agent        <string>     .D......... override User-Agent header (default "Lavf/61.9.107")
  ...
  -reconnect_max_retries <int>        .D......... the max number of times to retry a connection (from -1 to INT_MAX) (default -1)
  -reconnect_delay_total_max <int>        .D......... max total reconnect delay in seconds after which to give up (from 0 to 4294) (default 256)
  -respect_retry_after <boolean>    .D......... respect the Retry-After header when retrying connections (default true)
...
mov/mp4/tgp/psp/tg2/ipod/ismv/f4v muxer AVOptions:
  ...
  -movflags          <flags>      E.......... MOV muxer flags (default 0)
     ...
     hybrid_fragmented              E.......... For recoverability, write a fragmented file that is converted to non-fragmented at the end.
...
RTSP muxer AVOptions:
  ...
  -user_agent        <string>     .D......... override User-Agent header (default "Lavf61.9.107")
...
SWScaler AVOptions:
  -sws_flags         <flags>      E..V....... swscale flags (default bicubic)
     ...
     gauss                        E..V....... gaussian approximation
     sinc                         E..V....... sinc
     lanczos                      E..V....... lanczos (sinc/sinc)
  ...
  -src_v_chr_pos     <int>        E..V....... source vertical chroma position in luma grid/256 (from -513 to 1024) (default -513)
  -src_h_chr_pos     <int>        E..V....... source horizontal chroma position in luma grid/256 (from -513 to 1024) (default -513)
  -dst_v_chr_pos     <int>        E..V....... destination vertical chroma position in luma grid/256 (from -513 to 1024) (default -513)
  -dst_h_chr_pos     <int>        E..V....... destination horizontal chroma position in luma grid/256 (from -513 to 1024) (default -513)
  -sws_dither        <int>        E..V....... set dithering algorithm (from 0 to 5) (default auto)
     auto            1            E..V....... automatic selection
     none            0            E..V....... no dithering
     bayer           2            E..V....... ordered matrix dither
     ed              3            E..V....... full error diffusion
  ...
  -threads           <int>        E..V....... number of threads (from 0 to INT_MAX) (default 1)
     auto            0            E..V....... automatic selection
  -intent            <int>        E..V....... color mapping intent (from 0 to 3) (default relative_colorimetric)
     perceptual      0            E..V....... perceptual tone mapping
     relative_colorimetric 1            E..V....... relative colorimetric clipping
     saturation      2            E..V....... saturation mapping
     absolute_colorimetric 3            E..V....... absolute colorimetric clipping
...
AVFilter AVOptions:
   ...
   threads           <int>        ..F........ Allowed number of threads (from 0 to INT_MAX) (default auto)
     auto            0            ..F........ autodetect a suitable number of threads to use
...
aap AVOptions:
   ...
   projection        <int>        ..F.A...... set the filter projection (from 1 to 256) (default 2)
   mu                <float>      ..F.A....T. set the filter mu (from 0 to 1) (default 0.0001)
   delta             <float>      ..F.A....T. set the filter delta (from 0 to 1) (default 0.001)
...
afdelaysrc AVOptions:
   ...
   channel_layout    <channel_layout> ..F.A...... set channel layout (default "stereo")
   c                 <channel_layout> ..F.A...... set channel layout (default "stereo")
...
colorspace AVOptions:
   all               <int>        ..FV....... Set all color properties together (from 0 to 8) (default 0)
     ...
     smpte240m       7            ..FV....... 
     bt2020          8            ..FV....... 
   space             <int>        ..FV....... Output colorspace (from 0 to 17) (default 2)
     bt709           1            ..FV....... 
     fcc             4            ..FV....... 
     bt470bg         5            ..FV....... 
     smpte170m       6            ..FV....... 
   ...
   trc               <int>        ..FV....... Output transfer characteristics (from 0 to 18) (default 2)
     ...
     bt2020-10       14           ..FV....... 
     bt2020-12       15           ..FV....... 
   format            <int>        ..FV....... Output pixel format (from -1 to 161) (default -1)
     yuv420p         0            ..FV....... 
     yuv420p10       62           ..FV....... 
     yuv420p12       123          ..FV....... 
     yuv422p         4            ..FV....... 
...
(no)format AVOptions:
   ...
   color_spaces      <string>     ..FV....... A '|'-separated list of color spaces
   color_ranges      <string>     ..FV....... A '|'-separated list of color ranges
...
fsync AVOptions:
   file              <string>     ..FV....... set the file name to use for frame sync (default "")
   f                 <string>     ..FV....... set the file name to use for frame sync (default "")
...
overlay AVOptions:
   ...
   y                 <string>     ..FV.....T. set the y expression (default "0")
   eof_action        <int>        ..FV....... Action to take when encountering EOF from secondary input  (from 0 to 2) (default repeat)
     repeat          0            ..FV....... Repeat the previous frame.
     endall          1            ..FV....... End both streams.
     pass            2            ..FV....... Pass through the main input.
...
scale AVOptions:
   ...
   in_color_matrix   <int>        ..FV....... set input YCbCr type (from -1 to 17) (default auto)
     ...
     smpte240m       7            ..FV.......
     bt2020          9            ..FV.......
   out_color_matrix  <int>        ..FV....... set output YCbCr type (from 0 to 17) (default 2)
     auto            -1           ..FV.......
     bt601           5            ..FV.......
     bt470           5            ..FV.......
     smpte170m       5            ..FV.......
   ...
   out_range         <int>        ..FV....... set output color range (from 0 to 2) (default auto)
     ...
     tv              1            ..FV.......
     pc              2            ..FV.......
   in_chroma_loc     <int>        ..FV....... set input chroma sample location (from 0 to 6) (default auto)
     auto            0            ..FV.......
     unknown         0            ..FV.......
     left            1            ..FV.......
     center          2            ..FV.......
     ...
     bottomleft      5            ..FV.......
     bottom          6            ..FV.......
   out_chroma_loc    <int>        ..FV....... set output chroma sample location (from 0 to 6) (default auto)
     auto            0            ..FV.......
     unknown         0            ..FV.......
     left            1            ..FV.......
     center          2            ..FV.......
     ...
     bottomleft      5            ..FV.......
     bottom          6            ..FV.......
   in_primaries      <int>        ..FV....... set input primaries (from -1 to 22) (default auto)
     auto            -1           ..FV.......
     bt709           1            ..FV.......
     bt470m          4            ..FV.......
     bt470bg         5            ..FV.......
     ...
     jedec-p22       22           ..FV.......
     ebu3213         22           ..FV.......
   out_primaries     <int>        ..FV....... set output primaries (from -1 to 22) (default auto)
     auto            -1           ..FV.......
     bt709           1            ..FV.......
     bt470m          4            ..FV.......
     bt470bg         5            ..FV.......
     ...
     jedec-p22       22           ..FV.......
     ebu3213         22           ..FV.......
   in_transfer       <int>        ..FV....... set output color transfer (from -1 to 18) (default auto)
     auto            -1           ..FV.......
     bt709           1            ..FV.......
     bt470m          4            ..FV.......
     gamma22         4            ..FV.......
     ...
     smpte428        17           ..FV.......
     arib-std-b67    18           ..FV.......
   out_transfer      <int>        ..FV....... set output color transfer (from -1 to 18) (default auto)
     auto            -1           ..FV.......
     bt709           1            ..FV.......
     bt470m          4            ..FV.......
     gamma22         4            ..FV.......
   ...
   reset_sar         <boolean>    ..FV....... reset SAR to 1 and scale to square pixels if scaling proportionally (default false)
...
setparams AVOptions:
   ...
   color_trc         <int>        ..FV....... select color transfer (from -1 to 18) (default auto)
     ...
     smpte428        17           ..FV.......
     arib-std-b67    18           ..FV.......
   colorspace        <int>        ..FV....... select colorspace (from -1 to 17) (default auto)
     ...
     ictcp           14           ..FV.......
     ipt-c2          15           ..FV.......
   chroma_location   <int>        ..FV....... select chroma sample location (from -1 to 6) (default auto)
...
setpts AVOptions:
   ...
   strip_fps         <boolean>    ..FV....... Unset framerate metadata (default false)
...
xpsnr AVOptions:
   stats_file        <string>     ..FV....... Set file where to store per-frame XPSNR information
   f                 <string>     ..FV....... Set file where to store per-frame XPSNR information
...
ddagrab AVOptions:
   ...
   dup_frames        <boolean>    ..FV....... duplicate frames to maintain framerate (default true)
...
gradients AVOptions:
   ...
   duration          <duration>   ..FV....... set video duration (default -0.000001)
   d                 <duration>   ..FV....... set video duration (default -0.000001)
   speed             <float>      ..FV.....T. set gradients rotation speed (from 0 to 1) (default 0.01)
   ...
   t                 <int>        ..FV.....T. set gradient type (from 0 to 4) (default linear)
     linear          0            ..FV.....T. set linear gradient
     radial          1            ..FV.....T. set radial gradient
     circular        2            ..FV.....T. set circular gradient
     spiral          3            ..FV.....T. set spiral gradient
...
perlin AVOptions:
   ...
   rate              <video_rate> ..FV....... set video rate (default "25")
   r                 <video_rate> ..FV....... set video rate (default "25")
   octaves           <int>        ..FV....... set the number of components to use to generate the noise (from 1 to INT_MAX) (default 1)
   persistence       <double>     ..FV....... set the octaves persistence (from 0 to DBL_MAX) (default 1)
   xscale            <double>     ..FV....... set x-scale factor (from 0 to DBL_MAX) (default 1)
   yscale            <double>     ..FV....... set y-scale factor (from 0 to DBL_MAX) (default 1)
   tscale            <double>     ..FV....... set t-scale factor (from 0 to DBL_MAX) (default 1)
   random_mode       <int>        ..FV....... set random mode used to compute initial pattern (from 0 to 2) (default random)
   ...
   random_seed       <unsigned>   ..FV....... set the seed for filling the initial pattern (from 0 to UINT32_MAX) (default 0)
   seed              <unsigned>   ..FV....... set the seed for filling the initial pattern (from 0 to UINT32_MAX) (default 0)
...
showcwt AVOptions:
   ...
   scale             <int>        ..FV....... set frequency scale (from 0 to 8) (default linear)
     linear          0            ..FV....... linear
     log             1            ..FV....... logarithmic
     bark            2            ..FV....... bark
     mel             3            ..FV....... mel
   ...
   direction         <int>        ..FV....... set direction mode (from 0 to 3) (default lr)
     ...
     ud              2            ..FV....... up to down
     du              3            ..FV....... down to up
   bar               <float>      ..FV....... set bargraph ratio (from 0 to 1) (default 0)
...
abuffer AVOptions:
   ...
   channel_layout    <channel_layout> ..F.A......
...
buffer AVOptions:
   ...
   colorspace        <int>        ..FV....... select colorspace (from 0 to 17) (default unknown)
     gbr             0            ..FV.......
     bt709           1            ..FV.......
     unknown         2            ..FV.......
     fcc             4            ..FV.......
     ...
     ictcp           14           ..FV.......
     ipt-c2          15           ..FV.......
   range             <int>        ..FV....... select color range (from 0 to 2) (default unspecified)
     unspecified     0            ..FV.......
     unknown         0            ..FV.......
     limited         1            ..FV.......
     tv              1            ..FV.......
...
abuffersink AVOptions:
   sample_fmts       <binary>     ..F.A.....P set the supported sample formats
   sample_rates      <binary>     ..F.A.....P set the supported sample rates
   ch_layouts        <string>     ..F.A.....P set a '|'-separated list of supported channel layouts
   all_channel_counts <boolean>    ..F.A.....P accept all channel counts (default false)
   sample_formats    [<sample_fmt>]..F.A...... array of supported sample formats
   samplerates       [<int>     ]..F.A...... array of supported sample formats
   channel_layouts   [<channel_layout>]..F.A...... array of supported channel layouts

buffersink AVOptions:
   pix_fmts          <binary>     ..FV......P set the supported pixel formats
   color_spaces      <binary>     ..FV......P set the supported color spaces
   color_ranges      <binary>     ..FV......P set the supported color ranges
   pixel_formats     [<pix_fmt> ]..FV....... array of supported pixel formats
   colorspaces       [<int>     ]..FV....... array of supported color spaces
   colorranges       [<int>     ]..FV....... array of supported color ranges
...
dovi_rpu_bsf AVOptions:
  -strip             <boolean>    ...V....B.. Strip Dolby Vision metadata (default false)
  -compression       <int>        ...V....B.. DV metadata compression mode (from 0 to 3) (default limited)
     none            0            ...V....B.. Don't compress metadata
     limited         1            ...V....B.. Limited metadata compression
     extended        3            ...V....B.. Extended metadata compression
...
h265_metadata_bsf AVOptions:
  ...
  -width             <int>        ...V....B.. Set width after crop (from -1 to 16888) (default -1)
  -height            <int>        ...V....B.. Set height after crop (from -1 to 16888) (default -1)
